...
$objCliente1= new Cliente("Javier", "Castillo",true,"DNI", 48);
...
echo "Importe: ".$empresa->registrarVenta([11,12,13],$objCliente2)."\n";
$ventasDeUnCliente=$empresa->retornarVentasXCliente("DNI",32);
